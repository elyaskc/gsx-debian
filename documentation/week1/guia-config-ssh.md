...
Para hacer esto tenemos que ir a la configuración de VirtualBox y en el apartado red clicar en la opcion de reenvio de puertos y añadir una nueva regla con los campos:
